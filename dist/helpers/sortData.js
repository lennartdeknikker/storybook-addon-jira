...
var sortData = function sortData(data) {
  ...
  var subTasks = data === null || data === void 0 ? void 0 : (_data$fields = data.fields) === null || _data$fields === void 0 ? void 0 : _data$fields.subtasks;
  var groupedOnStatus = {
    toDo: [],
    inProgress: [],
    readyForTest: [],
  ...
  var _iterator = _createForOfIteratorHelper(subTasks),
      _step;
